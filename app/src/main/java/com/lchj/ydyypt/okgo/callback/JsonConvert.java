...
import com.lchj.ydyypt.MainApplication;
    ...
    private T parseParameterizedType(Response response, ParameterizedType type) throws Exception {
        ...
        if (rawType != ResultInfo.class) {
            ...
            if (typeArgument == Void.class) {
                ...
                response.close();
                //noinspection unchecked
                return (T) simpleResponse.toResultInfo();
            } else {
                // 泛型格式如下： new JsonCallback<LzyResponse<内层JavaBean>>(this)
                ResultInfo resultInfo = Convert.fromJson(jsonReader, type);
                response.close();
                boolean success = resultInfo.getSuccess();
                //这里的0是以下意思
                ...
                if (success) {
                    ...
                    throw new IllegalStateException("错误信息：" + resultInfo.getMsg());
                }
            }
        }
    }
